...
<ul class="nav nav-tabs" id="myTab">
        <li class="active"><a data-toggle="tab" href="#group">Student Information</a></li>
        <li><a data-toggle="tab" href="#proposal">Project Information</a></li>
        <li><a data-toggle="tab" href="#comments">Project Comments</a></li>
        <li><a data-toggle="tab" href="#deliverable">Project Deliverables</a></li>
        <li><a data-toggle="tab" href="#future">Project Result</a></li>
    </ul>
...
<!--end here-->
    ...
    <div id="comments" class="tab-pane fade">
        <?php include("projectComment.php");?>
    </div>

    <div id="deliverable" class="tab-pane fade">
        <?php 
            include("projectDeliverable.php");
        ?>
    </div>

    <div id="future" class="tab-pane fade">
        <?php 
            include("projectResult.php");
        ?>
    </div>
    </div>   
</div>
