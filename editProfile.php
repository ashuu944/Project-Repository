                ...
                <div class="row">
                    <div class="col-md-11">
                        ...
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal" role="form" action="updateProfile.php" method="post" >
                    <div class="row">
                                                <?php 
                                        ...
                                        <div class="form-group">
                                              ...
                                              <div class="col-md-10">
                                                <select  name = "prgID" class = "form-control" required style="margin-bottom: 10px;">
                                                    <option value = "<?php echo $prj['techID'];?>"><?php echo $std['prgName'];?></option>
                                                <?php   
                                                
                                            foreach ($obj->viewProgramme() as $cat) {
                                                ?>                                                                              
                                                <option value = "<?php echo $cat['prgID'];?>"><?php echo $cat['prgName'];?></option>  
                                                <?php } ?>                                                               
                                            </select>
                                              </div>
                                        </div>
