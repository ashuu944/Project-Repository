                                    ...
                                    <div id="user-profile-1" class="user-profile row">
                                        ...
                                        <div class="col-xs-12 col-sm-3 center">
                                            <div>
                                                <span class="profile-picture">
                                                    <img id="avatar" class="editable img-responsive" alt="Alex's Avatar" src="profile_pic/img.jpg" width="150px" height="100px" />
                                                </span>
                                            ...
                                            <div class="profile-contact-info">
                                                <div class="profile-contact-links align-left">
                                                    ...
                                                    <a href="#update<?php echo $std['stdID'] ?>" class="btn btn-link"  data-toggle = "modal"  data-target="#update<?php echo $std['stdID'] ?>"><i class = "glyphicon glyphicon-cog"></i> Edit Profile</a>
                                        ...
                                        <div class="col-xs-12 col-sm-9">
                                            ...
                                            <div class="profile-user-info profile-user-info-striped">
                                                ...
                                                <div class="profile-info-row">
                                                    <div class="profile-info-name"> Reg. Number </div>

                                                    <div class="profile-info-value">
                                                        <span class="editable" id="age"><?php echo $std['regNo']?></span>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="profile-info-row">
                                                    ...
                                                    <div class="profile-info-value">
                                                        <span class="editable" id="signup"> <?php echo $std['prgName']?></span>
                                                    </div>
                                                </div>
