                ...
                <div class="row">
                    <div class="col-md-11">
                        ...
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal" role="form" action="uploadPixSup.php" method="post" enctype="multipart/form-data">
                    <div class="row">
                                                <?php 
                            ...
                            <div class="col-md-3 center">
                                            <div>
                                                <span class="profile-picture">
                                                    <img id="avatar" class="img-responsive img-thumbnail" alt="No image" src="<?php echo $std['profilePic'];?>" width="100px" height="90px" />
                                                </span>
                                                ...
                                                <div class="profile-contact-links align-left">
                                                    ...
                                                    <div class="form-group">
                                                        <input type="hidden" class="form-control" name="sprID" value="<?php echo $std['sprID'];?>">
                                                    ...
                                                    <a href="updateSuper.php" class="btn" style="color:green;"><i class = "glyphicon glyphicon-cog"></i> Edit Profile</a>
                    ...
                    <?php include 'updateProfileModal2.php';?>
