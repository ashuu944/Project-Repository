...
include('session.php');
    ...
    foreach ($obj->viewProposal($prevID) as $s) {
        $prevTitle=$s['title'];
    }
?>
<html lang="en">
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default" style="margin-left:-30px;">
                            ...
                            <div class="panel-body">
								...
								<a href="proposals.php" class="btn btn-info" onclick="showDiv()" > New Project</a>&nbsp &nbsp
								<a href="selectProject.php" class="btn btn-info" > Customization of Project</a>
								</div>
								</div>
								<div  class="row" style="margin-top:20px;">
                                    <div class="col-lg-12" id="pDiv">
                                        <form role="form" action="sendProposal.php" method="post" class="form-horizontal" enctype="multipart/form-data">

                                              <div class="form-group">
                                               <input type="hidden" name="prevID" value="<?php echo $prevID;?>">
                                                <label class="col-md-2 control-label">Project To be customized</label>
                                                <div class="col-md-10">
                                                <input type="text" readonly="readonly" style="background-color: white" class="form-control " name="prevTitle" value="<?php echo $prevTitle?>">
                                                </div>
                                                
                                            </div>
                                            <div class="form-group">
                                               
                                                <label class="col-md-2 control-label"> Document of Limitation and Solution</label>
                                                <div class="col-md-10">
                                                <input type="file" class="form-control " name="projLim_path" required>
                                                </div>
                         ...
                         <label class="col-md-2 control-label">Technology</label>
                          <div class="col-md-4">
                            <select  name = "techID" class = "form-control" required>
                                            ...
                                            <button type="submit" class="btn btn-success" name="customize">Send Proposal</button>
